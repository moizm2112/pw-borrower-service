...
public final class AppConstants {
	...
	//=============Validation Errors------------------------
	public static final String FIRST_NAME_VALIDATION_MESSAGE="First Name should contain atleast one alphabet.";
	public static final String FIRST_NAME_LENGTH_VALIDATION_MESSAGE="First Name must be greater than 3 character in length";
	public static final String LAST_NAME_VALIDATION_MESSAGE="Last Name should contain atleast one alphabet.";
	public static final String MIDDLE_NAME_VALIDATION_MESSAGE="Middle Name should contain atleast one alphabet.";
	public static final String LAST_NAME_LENGTH_VALIDATION_MESSAGE="Last Name must be greater than 2 character in length";
	public static final String ADDRESS_VALIDATION_MESSAGE="Address line must contain numbers and alphanumeric strings.";
	public static final String CITY_VALIDATION_MESSAGE="City should contain only alphabets";
	public static final String STATE_VALIDATION_MESSAGE="State must contain maximum of 2 charactes";
	public static final String ZIP_VALIDATION_MESSAGE="Zip should contain only numeric";
	public static final String ZIP_LENGTH_VALIDATION_MESSAGE="Zip must be 5 digits long";
	public static final String LAST4TIN_VALIDATION_MESSAGE="Last4TIN should contain only numeric";
	public static final String LAST4TIN_LENGTH_VALIDATION_MESSAGE="Last4TIN must be 4 digits long";
	public static final String FINANCEDAMOUNT_VALIDATION_MESSAGE="Financed Amount should contain only numeric";
	...
	public static final String LAST_NAME_NULL_VALIDATION_MESSAGE="Last Name Can't be null.";
	public static final String EMAIL_FORMAT_VALIDATION_MESSAGE ="Email is not in valid format.";
	public static final String MOBILENO_FORMAT_VALIDATION_MESSAGE ="MobileNo is not in valid format.";
	public static final String EMAIL_NULL_VALIDATION_MESSAGE ="Email can't be null.";
	public static final String MOBILENO_NULL_VALIDATION_MESSAGE="Phone Number can't be null.";
	...
	public static final String FINANCEDAMOUNT_NULL_VALIDATION_MESSAGE="Financed Amount can't be null.";
	public static final String EMPLOYER_NULL_VALIDATION_MESSAGE="Employer can't be null.";
	public static final String LENDER_NULL_VALIDATION_MESSAGE="Lender can't be null.";
	public static final String BANKABA_NULL_VALIDATION_MESSAGE="Bank ABA can't be null.";
	public static final String BANKACCOUNTNUMBER_NULL_VALIDATION_MESSAGE="Bank Account number can't be null.";
	public static final String VIRTUALACCOUNT_NULL_VALIDATION_MESSAGE="Virtual Account can't be null.";
