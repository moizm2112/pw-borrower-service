...
//	public static final String MOBILENO_LENGTH_VALIDATION_MESSAGE ="MobileNo supported only these formats (IND - +911234567890(13 digits) or US - +11234567890(12 digits) format)";
	...
	public static final String REPAYMENTFREQUENCY_NOT_VALID_MESSAGE="Repayment frequency entered is not valid. Eg: For MONTHLY,WEEKLY";
	
	
	
	public static final String INSTALLMENTAMOUNT_NULL_VALIDATION_MESSAGE="Installment Amount cannot be 0.";
	public static final String TOTALNOOFREPAYMENT_NULL_VALIDATION_MESSAGE="Total Number Of Repayment cannot be 0.";
